class ImportsController < ApplicationController
    ...
    def artist_releases
        ...
        releases = client.search_artist_releases(artist.name, max_results: import_artist_releases_params[:max_results])
        ...
        redirect_to artist_releases_path(artist_id: params['arttist_id'].to_i) # , notice "Releases import sucessfully"

        # para debugar o codigo no ruby: 
        # binding.pry
